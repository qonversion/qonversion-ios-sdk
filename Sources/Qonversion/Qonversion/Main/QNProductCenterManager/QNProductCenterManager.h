...
@protocol QONPromoPurchasesDelegate, QONEntitlementsUpdateListener, QONDeferredPurchaseListener, QNUserInfoServiceInterface, QNIdentityManagerInterface, QNLocalStorage;
