...
@class QNEntitlement, QNProduct, QNOfferings, QNIntroEligibility, QNExperimentInfo, QNUser;
...
typedef void (^QNEntitlementsCompletionHandler)(NSDictionary<NSString *, QNEntitlement*> *result, NSError  *_Nullable error) NS_SWIFT_NAME(Qonversion.EntitlementsCompletionHandler);

typedef void (^QNPurchaseCompletionHandler)(NSDictionary<NSString *, QNEntitlement*> *result, NSError  *_Nullable error, BOOL cancelled) NS_SWIFT_NAME(Qonversion.PurchaseCompletionHandler);
...
typedef void (^QNRestoreCompletionHandler)(NSDictionary<NSString *, QNEntitlement*> *result, NSError  *_Nullable error) NS_SWIFT_NAME(Qonversion.RestoreCompletionHandler);
